...
#开始匹配Smiles
result = pd.read_csv('whole.csv')
print('catching Smiles for TOP 10000 result by HitCount ...')
print('delete BarCode duplicated ...')
result = result.drop_duplicates(subset='BarCode')
result = result.sort_values(by='HitCount', ascending=False)
...
output_data = None
output = output.sort_values(by='HitCount', ascending=False)
